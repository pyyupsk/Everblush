...
const main = async () => {
    ...
    for (const [colorName, colorHex] of Object.entries(colors)) {
        ...
        const out = createWriteStream(join(OUTPUT_FOLDER, `${colorName}.png`));
    ...
    for (const [colorName, colorHex] of Object.entries(colors)) {
        ...
        mdFile.write(`<tr>\n`);
        mdFile.write(`<td><img src="assets/palette/${colorName}.png" alt="${colorName}"></td>\n`);
        ...
        mdFile.write(`</tr>\n`);
        console.log(`Added ${colorName} to palette.md`);
        console.log('----------------');
    }
    mdFile.write('</table>');
    mdFile.end();
    console.log('palette.md created');
